<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMst.Master" AutoEventWireup="true" CodeBehind="DersGideri.aspx.cs" Inherits="OkulYonetimSistemi.Admin.DersGideri" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div style="background-image:url('../Image/bg4.jpg'); width:100%; height:720px; background-repeat: no-repeat; background-size:cover; background-attachment:fixed;"> 
        <div class="container p-md-4 p-sm-4">
            ...
            <h3 class="text-center">Ders Gideri Ekle</h3>
            ...
            <div class="col-md-6 mt-2">
                    <label for="txtDersGideriUcrt">Ucret Tutarı(Ders Başına)</label>
                <asp:TextBox ID="txtDersGideriUcrt" runat="server" CssClass="form-control" placeholder="Ucret Tutarını Girin" TextMode="Number" required></asp:TextBox>
            </div>
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#5558C9" Text="Ders Gideri Ekle" OnClick="btnAdd_Click" />
                    </div>
                </div>
             ...
             <div class="row mb-3 mr-lg-5 ml-lg-5">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" EmptyDataText="Görüntülenecek Kayıt Yok!" 
                        ...
                        DataKeyNames="DersGideriId" OnRowCancelingEdit="GridView1_RowCancelingEdit"  OnRowEditing="GridView1_RowEditing"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Ders">
                             ...
                             <asp:TemplateField HeaderText="Ücret Toplamı(Ders Başına)">
                                <EditItemTemplate>
                                 <asp:TextBox ID="txtDersGideriUcrt" runat="server" CssClass="form-control" Text='<%# Eval("UcretTutari") %>' TextMode="Number"></asp:TextBox>   
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("UcretTutari") %>' ></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
